...
if(length(args)==0){
  ...
  #inJsonFile <-"1403052563_59.cfg" #Algorithm 1
  #inJsonFile <- "1402498204_77.cfg" #Algorithm 2
  #inJsonFile <- "1403057631_99.cfg" #Algorithm 3
  inJsonFile <- "1403069485_48.cfg" #Algorithm 3
  #print("no args")
} else {
  inJsonFile <- args[[1]]
  print(inJsonFile)
...
if ( inJsonData$Algorithm == 0 || inJsonData$Algorithm == 1 ) {
  ...
  cat(paste('"semCUB"',":", '"', round (0.4 * SpendRange$Spend_SEM_Max_Dollars,roDgt), '"',",\n",sep=""))
  cat(paste('"semPUB"',":", '"', round (0.2 * SpendRange$Spend_SEM_Max_Dollars,roDgt), '"',",\n",sep=""))
  cat(paste('"semOUB"',":", '"', round (0.3 * SpendRange$Spend_SEM_Max_Dollars,roDgt), '"',",\n",sep=""))
  cat(paste('"semBUB"',":", '"', round (0.5 * SpendRange$Spend_SEM_Max_Dollars,roDgt), '"',",\n",sep=""))
  ...
  cat(paste('"dirSpendM1"',":",'"', "112000",'"',",\n",sep=""))
  cat(paste('"dirSpendM2"',":",'"', "113000",'"',",\n",sep=""))
  cat(paste('"dirSpendM3"',":",'"', "114000",'"',",\n",sep=""))
  ...
  sink()
    ...
    cat(paste('"SpendLB"',":", '"', inJsonData$SpendLB, '"',",\n",sep=""))  
    ...
    cat(paste('"SpendUB"',":", '"', inJsonData$SpendUB, '"',",\n",sep=""))  
    ...
    cat(paste('"dirSpendM1"',":",'"', inJsonData$dirSpendM1, "",'"',",\n",sep=""))
    cat(paste('"dirSpendM2"',":",'"', inJsonData$dirSpendM2, "",'"',",\n",sep=""))
    cat(paste('"dirSpendM3"',":",'"', inJsonData$dirSpendM3, "",'"',",\n",sep=""))
    ...
    semSRVal <- semCSRVal + semPSRVal + semOSRVal + semBSRVal
    ...
    cat(paste('"disSlideRight"',":",'"', inJsonData$disUB, '"',",\n",sep=""))
