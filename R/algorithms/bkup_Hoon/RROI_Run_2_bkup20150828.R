...
cat("############# Forecast Starts #################\n")
      ...
      if(paste0(ChannelName[i],"_", AttributionModel) %in% ls_RegUsingLags){
                      revPred_allchannel = c( revPred_allchannel,                        
                                  ...
                                  if(SkipMonths==0){
                                                    print("fc_a_3")
                                                    if(IncludeDataForThePeriod=="NO"){ #For Planforward, it's always 'NO'.                                             
                                                    ...
                                                    print("fc_a_4")
                                                      ...
                                                      NegativeChannelRevCalculation<-function(E){
                                                                ...
                                                                Fitted_Rev_with_Restated_Spending <- (
                                                                                                  Beta*z[2]+mu +
                                                                      phi_1*      (Revenue_set[3]-Beta*E[3]-mu)+
                                                                      phi_2*      (Revenue_set[4]-Beta*E[4]-mu)-
                                                                      phi_1*phi_2*(Revenue_set[5]-Beta*E[5]-mu))
                                                                      #Rev_set[3]:Rev_l1
                                                                      #Rev_set[4]:Rev_l12
                                                                      #Rev_set[5]:Rev_l13
                                                                      #z[2]:Spending
...
commafmt <- function(x)  format(x,  big.mark=",", big.interval=3)
  ...
  cat(paste0('"run1ProjROI":',     '"', inJsonData$run1ProjROI,   '",\n'))
